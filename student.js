...
editProfileBtn.addEventListener('click', function() {
    editProfilePopup.style.display = 'flex'; // Show the edit profile popup
});
...
document.getElementById('save-profile-btn').addEventListener('click', function() {
    ...
    document.getElementById('student-email').textContent = `Email: ${email}`;
    document.getElementById('student-department').textContent = `Department: ${department}`;
    document.getElementById('student-phone').textContent = `Phone: ${phone}`;
